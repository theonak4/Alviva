...
<body>
  ...
  <div style="position: fixed; width: 50%; height: 100%; top: 5%; left: 425px;">
    <h1 style="margin-top: 5%">Insurance Forms</h1>
    <br>
    <a href="http://54.188.51.218/panel/forms/insurance/isf.pdf" target="_blank"><button type="button" class="btn btn-light btn-lg" style="border-radius: 0; width: 600;">view Insurance Claim Verification Form <img src="icons/chevron-double-right.svg" width="20"></img></button></a><br><br>
    <a href="http://54.188.51.218/panel/forms"><button type="button" class="btn btn-outline-primary" style="border-radius: 0;">back to all forms</button></a>
