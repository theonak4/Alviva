...
<div class="collapse" id="collapseExample">
  ...
  <div style="position: fixed; width: 50%; height: 100%; top: 5%; left: 425px;">
    <h1 style="margin-top: 5%">Manage Forms</h1>
    <br>

    <a href="http://54.188.51.218/panel/forms/club"><div style="width: 200; height: 200; border: 0; background: #fafafa;"><center><img src="soccerballicon.png" width=100 style="margin-top: 30; margin-bottom: 5;"></img><br><strong>club<br>information</strong></center></div></a> <br>
    <a href="http://54.188.51.218/panel/forms/insurance"><div style="width: 200; height: 200; border: 0; background: #fafafa;"><center><img src="insuranceicon.png" width=100 style="margin-top: 35"></img><br><strong>league<br>forms</strong></center></div></a> <br>
