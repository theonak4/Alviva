...
<div class="collapse" id="collapseExample">
  ...
  <li class="nav-item" style="border-radius: 0;">
    <a class="nav-link" href="http://54.188.51.218/panel/statistics/" style="border-radius: 0;"><strong>game statistics</strong></a>
  </li>
  <li class="nav-item" style="border-radius: 0;">
    <a class="nav-link active" style="border-radius: 0;">season statistics</a>
  </li>
</ul>
<br>
                  ...
                  <table class="table">
                    <tbody>
                      <tr>
                        <td>Clean Sheets</td>
                        <td></td>
                        <td><span style="font-weight: 600; font-size: 22;">5</span></td>
                      </tr>
                      <tr>
                        <td>Goals Conceded</td>
                        <td></td>
                        <td><span style="font-weight: 600; font-size: 22;">3</span></td>
                      </tr>
                      <tr>
                        <td>Tackles</td>
                        <td></td>
                        <td><span style="font-weight: 600; font-size: 22;">10</span></td>
                      </tr>
                      <tr>
                        <td>Tackle success (%)</td>
                        <td></td>
                        <td><span style="font-weight: 600; font-size: 22;">22</span></td>
                      </tr>
                      <tr>
                        <td>Last Man Tackles</td>
                        <td></td>
                        <td><span style="font-weight: 600; font-size: 22;">73</span></td>
                      </tr>
                      <tr>
                        <td>Interceptions</td>
                        <td></td>
                        <td><span style="font-weight: 600; font-size: 22;">7</span></td>
                      </tr>
                      <tr>
                        <td>Clearances</td>
                        <td></td>
                        <td><span style="font-weight: 600; font-size: 22;">65</span></td>
                      </tr>
                      <tr>
                        <td>Recoveries</td>
                        <td></td>
                        <td><span style="font-weight: 600; font-size: 22;">88</span></td>
                      </tr>
                      <tr>
                        <td>Own Goals</td>
                        <td></td>
                        <td><span style="font-weight: 600; font-size: 22;">0</span></td>
                      </tr>
                    </tbody>
                  </table>
