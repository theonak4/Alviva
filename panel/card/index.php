...
<body>
  ...
  <br>
  <h5><img src="icons/card-heading.svg" alt="" width="36" height="36" style="margin-right: 10px; margin-left: 3%;"><strong> view player card</strong></h5>
  <br>
...
<div class="collapse" id="collapseExample">
  ...
  <div style="position: fixed; width: 50%; height: 100%; top: 5%; left: 425px;">
    <h1 style="margin-top: 5%">Your Player's Player Card</h1>
    <br>
    <div class="card" style="border-radius: 0;">
  <h5 class="card-header"><strong>player card</strong></h5>
  <div class="card-body">
    <img src="card3.jpg" width=750></img>
  </div>
</div>
<br>
<!-- <button type="button" class="btn btn-primary btn-lg" style="border-radius: 0;">edit player card information</button> -->
