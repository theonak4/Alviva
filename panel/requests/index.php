...
if($page == "" || $page == null || $page < 0) {
  header("Location: http://54.188.51.218/panel/requests/?page=0");
} else if($page == 0) {
  ...
  <div style="position: fixed; width: 50%; height: 100%; top: 5%; left: 425px;">
      ...
      while($row = $accessRecords->fetch_assoc()) {
        ...
        <span href="#" class="list-group-item">
          ...
          <ul class="list-group list-group-horizontal-lg">
            <li class="list-group-item" style="border: 0; padding: 0;"><small style="font-weight: 600">date requested <h4 style="font-weight: 500; width: 250"><strong><?php echo date("F jS, Y", strtotime($row["date"])) ?></strong></h4></small></li>
            <li class="list-group-item" style="border: 0; padding: 0; margin-left: 30"><small style="font-weight: 600">reason <h4 style="font-weight: 500"><?php echo $row["reason"]; ?></h4></small></li>
          </ul>
          <br>
          <small style="font-weight: 600">information requested</small>

          <ul class="list-group list-group-horizontal" style="margin-top: 5;">
            <li class="list-group-item <?php if($row["d1"]) { echo 'list-group-item-success'; } else { echo 'list-group-item-light'; } ?>" style="border-radius: 0;">Birth Certificate</li>
            <li class="list-group-item <?php if($row["d2"]) { echo 'list-group-item-success'; } else { echo 'list-group-item-light'; } ?>" style="border-radius: 0;">CalSouth Registration Form</li>
            <li class="list-group-item <?php if($row["d3"]) { echo 'list-group-item-success'; } else { echo 'list-group-item-light'; } ?>" style="border-radius: 0;">Player Card</li>
          </ul>
          <br>
          <form action="http://54.188.51.218/panel/release.php" method="POST">
    ...
    <div class="card" style="width: 600; border:0; padding: 0; margin: 0; text-align: center">
      <div class="card-body" style="padding: 0;">
        ...
        <?php echo $playerFirst; ?>'s information has not been requested yet.
        <br>
        <br>
