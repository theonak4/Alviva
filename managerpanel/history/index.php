...
if($page == "" || $page == null || $page < 0) {
  header("Location: http://54.188.51.218/managerpanel/history/?page=0");
} else if($page == 0) {
...
<body>
  ...
  <div style="position: fixed; width: 50%; height: 100%; top: 5%; left: 425px;">
    ...
    if($accessRecords->num_rows > 0) {
      while($row = $accessRecords->fetch_assoc()) {
        ...
        <span href="#" class="list-group-item" style="border: 0; background: #fafafa;">
          ...
          <ul class="list-group list-group-horizontal-lg">
            <li class="list-group-item" style="border: 0; padding: 0;  background: #fafafa;"><small style="font-weight: 600">date requested <h4 style="font-weight: 500"><?php echo date("F jS, Y", strtotime($row["date"])) ?></h4></small></li>
            <li class="list-group-item" style="border: 0; padding: 0; margin-left: 30;  background: #fafafa;"><small style="font-weight: 600">date authorized <h4 style="font-weight: 500"><?php echo date("F jS, Y", strtotime($row["dateAuthorized"])) ?></h4></small></li>
          </ul>
          <br>
      ...
      <img src="icons/exclamation-diamond-fill.svg" width="20" style="margin-right: 5"></img> <strong>Alert</strong> Your team needs more information.
