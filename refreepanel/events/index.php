...
<body>
  ...
  <div style="position: fixed; width: 50%; height: 100%; top: 5%; left: 425px;">
    <h1 style="margin-top: 5%">Events</h1>
    <br>
    ...
    <br>
    <a href="http://54.188.51.218/refreepanel/binder"><div style="width: 200; height: 200; border: 1px solid gray;"><center><img src="clubicon.png" width=100 style="margin-top: 35"></img><br><strong>Blues Cup</strong></center></div></a> <br>
    <a href="http://54.188.51.218/panel/forms/club"><div style="width: 200; height: 200; border: 1px solid gray;"><center><img src="ecnl.jpg" width=100 style="margin-top: 35"></img><br><strong>ECNL Schedule</strong></center></div></a> <br>
