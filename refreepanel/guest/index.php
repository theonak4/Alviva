...
<body>
  ...
  <div class="input-group-prepend" style="border-radius: 0;">
    <span class="input-group-text" style="border-radius: 0;">Player First and Last Name</span>
  </div>
  <input type="text" aria-label="First name" class="form-control" placeholder="First" style="border-radius: 0;">
  <input type="text" aria-label="Last name" class="form-control" placeholder="Last" style="border-radius: 0;">
</div>
<br>
