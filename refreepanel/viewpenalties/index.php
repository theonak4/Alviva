...
<body>
  ...
  <br>
  <a href="http://54.188.51.218/refreepanel"><h5><img src="icons/person-fill.svg" alt="" width="36" height="36" style="margin-right: 10px; margin-left: 3%;"> <strong>your profile</strong> </h5></a>
  <br>
  ...
  <div style="position: fixed; width: 50%; height: 100%; top: 5%; left: 425px;">
    <h1 style="margin-top: 5%">Penalties</h1>
    <br>
...
<button type="button" class="btn btn-dark" style="border-radius: 0; font-size: 15px; font-weight: 600;">Report incorrect penalty</button>
