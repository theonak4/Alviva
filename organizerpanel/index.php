...
<body>
  ...
  <br>
  <h5><img src="managericon.png" alt="" width="36" height="36" style="margin-right: 10px; margin-left: 3%;"> <strong>your profile</strong></h5>
  <br>
  ...
  <br>
  <a href="http://54.188.51.218/organizerpanel/review" style="color: black"><h5><img src="icons/check.svg" alt="" width="36" height="36" style="margin-right: 10px; margin-left: 3%;"> review / approval</h5></a>
  <br>
  ...
  <div style="position: fixed; width: 50%; height: 100%; top: 5%; left: 425px;">
    <h1 style="margin-top: 5%">Your Profile</h1>
    <br>
    <div class="media" style="background: #fafafa; padding: 20; width: 600">
      <img src="headshot.gif" class="mr-3" alt="..." style="width: 60; height: 60; border-radius: 50%">
        <div class="media-body">
          <h4 class="mt-0" style="font-weight: 800; margin-bottom: 0; padding-bottom: 0;">SoCal Blues</h4>
          <h4 style="margin: 0;">registrar account</h4>
        </div>
    </div>

    <br>
    <a href="http://54.188.51.218/organizerpanel/event"><div style="width: 300; height: 300; border: 1px solid gray;"><center><img src="icons/calendar.svg" width=150 height=150 style="margin-top: 35; margin-bottom: 35;"></img><br><strong>open club<br>registrar details</strong></center></div></a> <br>
    <br>
    <?php

    if($_GET["eventcreated"]) {
      echo "<div class='alert alert-success alert-dismissible fade show' role='alert' style='border-radius: 0;'>
